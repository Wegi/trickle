...
/* Require modules */
var animateBoxes, api, baseZIndex, boxName, child_content, configDialogue, config_dialogue_box_remove, config_dialogue_edit, config_dialogue_module_add, config_dialogue_module_removal, control_box_drag_resize, control_menu_show_edit_hide_standard, control_menu_show_standard_hide_edit, createBox, create_module_list_items, data, destroy_module, fs, getNextNum, getNumFromName, gui, home_path, init_done, lightboxCloseDelay, load_conf, load_module, modpath, module, modules, num, path, selectedBox, session, showConfig, toggle_control_menu, value, win, _base, _base1, _i, _len, _ref, _ref1,
