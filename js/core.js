...
download_module = function(name, repo) {
  var download, file;
  ...
  return file.run(function(err, files, stream) {
    if (err) {
      throw err;
    }
    return console.log("File downloaded successfully!");
  });
};
...
installable_modules = function() {
  ...
  return $(".module-single").click(function() {
    return download_module(repo.name, repo.repo);
  });
};
...
config_dialogue_module_add = function(boxContentId, boxOuterId) {
  ...
  $("#installable-modules").click(function() {
