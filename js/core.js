...
/* Require modules */
var baseZIndex, boxName, configDialogue, content_id, createBox, data, fs, getNextNum, getNumFromName, gui, home_path, init_done, list, load_conf, load_module, loaded_modules, modpath, module, modules, num, outer_id, path, selectedBox, session, value, win, _i, _len, _ref, _ref1, _ref2,
...
for (boxName in _ref) {
  ...
  _ref1 = createBox(num), content_id = _ref1[0], outer_id = _ref1[1];
  ...
  if (loaded_modules[boxName]) {
    console.log("inside da loop");
    _ref2 = loaded_modules[boxName];
