...
/* Require modules */
var baseZIndex, boxName, child_content, configDialogue, createBox, create_module_list_items, data, fs, getNextNum, getNumFromName, gui, home_path, init_done, list, list_loaded_modules, load_conf, load_module, modpath, module, modules, num, path, selectedBox, session, toggle_highlighted_boxes, value, win, _i, _len, _ref, _ref1,
...
list_loaded_modules = function() {
  ...
  return $("#config-box").lightbox_me().html(content);
};
