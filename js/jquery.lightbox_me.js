...
$(function() {
  $.fn.lightbox_me = function(options) {
    return this.each(function() {
      var $currentOverlays, $iframe, $overlay, $self, closeLightbox, observeKeyPress, opts, setOverlayHeight, setSelfPosition;
  ...
  return $.fn.lightbox_me.defaults = {
    appearEffect: "fadeIn",
    appearEase: "",
    overlaySpeed: 250,
    lightboxSpeed: 300,
